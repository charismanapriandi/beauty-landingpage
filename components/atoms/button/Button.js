...
const Button = ({ label, withIcon, icon, primary, primaryOutline }) => {
  return (
    <button className={`${primary && 'bg-gradient-to-r from-custom-cream-400 to-custom-cream-300'} ${primaryOutline && 'border-2 border-custom-cream-400'} items-center px-6 py-3 flex`}>
