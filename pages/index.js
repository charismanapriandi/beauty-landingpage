    ...
    <div>
      ...
      <section className="bg-custom-cream-100 flex items-center justify-between h-screen relative overflow-hidden">
        <Container>
          ...
          {/* <div className="flex justify-between"> */}
            ...
            {/* <div className=" h-screen items-center justify-between"> */}
              <div className="flex-1">
                <h1 className="font-bold text-6xl leading-relaxed font-playfair">
                  Beautiful people <br />
              ...
              <div className="absolute -bottom-2 right-20" style={{height: '605.88px', width: '637px'}}>
                <Image 
          ...
          {/* </div> */}
          <div className="absolute z-10 right-0 bottom-0 p-7 backdrop-blur-md backdrop-filter bg-opacity-50 bg-white w-96">
        ...
        <Container>
          <div>
            ...
            <div className="flex justify-between items-end">
              <h1 className="font-bold text-5xl leading-relaxed font-playfair w-1/2">Beauty is power, a smile is the sword</h1>
              <Button
                label={'READ MORE'}
                primaryOutline
                withIcon
